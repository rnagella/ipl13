 ...
 */
function MostFours(title) {
	var url = 'http://www.cs.odu.edu/~rnagella/ipl13/most-fours.json';
	//var fileName="most-fours.json";
	...
	function mostFourssData(response) {
		...
		var image1 = Ti.UI.createImageView({
			...
			width : 60,
			left : 10,
			image : '/images/tableview/Sachin-Tendulkar.png' //response.mostfours[0].image
		...
		var item1 = Ti.UI.createLabel({
			...
			text : response.mostfours[0].Player,
			font : {
				fontSize : 20
			},
			top : 20,
		...
		var teamValue = Ti.UI.createLabel({
			...
			text : response.mostfours[0].Team,
			font : {
				fontSize : 20
			},
			top : 20,
		...
		var sixesValue = Ti.UI.createLabel({
			...
			text : response.mostfours[0].Fours,
			font : {
				fontSize : 20
			},
			top : 50,
